		...
		<Container size="xl" className="space-y-6">
			<PageHeader
				...
				actions={
					<PembelianDialog
						trigger={
							<span className="press-down inline-flex h-9 items-center gap-1.5 rounded-lg bg-primary px-3 text-fluid-caption font-medium text-primary-foreground hover:bg-primary/90">
