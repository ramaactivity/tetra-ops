...
export function Fab({
	...
	return (
		<Link
			...
			aria-label={label}
			className={cn(
				"press tap fixed right-4 bottom-[calc(5rem+env(safe-area-inset-bottom))] z-40 flex size-14 items-center justify-center rounded-2xl bg-[#059669] text-white shadow-[var(--shadow-fab)] active:scale-95",
				className,
			)}
		>
