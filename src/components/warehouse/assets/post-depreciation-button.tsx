				...
				<DialogContent className="sm:max-w-md">
					...
					<DialogFooter>
						...
						<button
							...
							onClick={handlePost}
							disabled={pending}
							className="bg-[#059669] dark:bg-[#0b9e6a] text-white hover:bg-[#047857] dark:hover:bg-[#059669] press-down inline-flex h-9 items-center rounded-md px-3 text-[12px] font-medium disabled:opacity-60"
						>
