			...
			{canReceive && isEditable && (
				<div className="flex flex-wrap items-center justify-end gap-2">
					...
					<button
						...
						disabled={pending}
						className="press-down inline-flex h-9 items-center gap-1.5 rounded-md bg-primary px-3 text-fluid-caption font-medium text-primary-foreground hover:bg-primary/90 disabled:opacity-60"
					>
