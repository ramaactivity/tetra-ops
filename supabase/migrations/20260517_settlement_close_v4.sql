-- 20260517_settlement_close_v4.sql
-- Iterasi v4 dari close_event_settlement(): tambah dukungan 'bonus' key
-- di JSONB p_hpp untuk track freebie cost (event_bonuses × purchase_price).
-- Disimpan ke kolom event_settlements.hpp_bonus (migration 20260517) dan
-- masuk hpp_total seperti bucket HPP lain.
--
-- Signature sama dengan v3 — CREATE OR REPLACE cukup, tidak perlu DROP.
-- Idempotent.
...
BEGIN
	...
	-- v4: bonus key included in hpp_total
