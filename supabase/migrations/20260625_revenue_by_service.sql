-- 20260625_revenue_by_service.sql
-- D — Pendapatan per jenis layanan. record_payment_je sekarang kredit akun
-- pendapatan sesuai events.service_type (bukan selalu 4-100), supaya Laba-Rugi
-- menampilkan pendapatan terpecah per layanan. Sisa logika sama (cash-basis,
-- atomik). CREATE OR REPLACE, idempotent.
